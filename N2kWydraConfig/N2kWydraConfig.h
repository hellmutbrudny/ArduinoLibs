...
const uint16_t N2K_DEVICE_REGISTRATION = 666; // Just choosen free from code list on http://www.nmea.org/Assets/20121020%20nmea%202000%20registration%20list.pdf
  ...
  unsigned char REGISTERS_ARRAY[] = {N2KREG_SteppersSpeed, N2KREG_ThrottleResetTime, N2KREG_GearResetTime, N2KREG_ThrottleMaxPos, N2KREG_EngineReportFreq, N2KREG_Gear, N2KREG_SetThrottle, N2KREG_EngineModuleState, N2KREG_Throttle, 0};
  int32_t REGISTER_VALUES_ARRAY[] = {200, 6000, 4000, 2500, 4000, 0, 0, 0, 0};
  #define OVER_handleRegisterChange
  #define OVER_sensorValueForReg
  ...
  const unsigned char N2K_DEVICE_FUNCTION = 150;
  const unsigned char N2K_DEVICE_CLASS = 40;
  unsigned char REGISTERS_ARRAY[] = {N2KREG_SetAutopilotState, N2KREG_SetAutopilotCourse, N2KREG_SetAutopilotTurnSpeed, N2KREG_SetAutopilotRudderPosition, N2KREG_SetAutopilotRudderSpeed, N2KREG_AutopilotShuntPower, N2KREG_AutopilotMoveDirection, 0};
  int32_t REGISTER_VALUES_ARRAY[] = {0, 0, 0, 0, 0, 0, 0};
  #define OVER_handleRegisterChange
