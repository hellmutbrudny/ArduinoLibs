...
boolean Adafruit_LSM6DS::begin_I2C(uint8_t i2c_address, TwoWire *wire,
  ...
  Serial.println("Adafruit_LSM6DS::begin_I2C");
  i2c_dev = new Adafruit_I2CDevice(i2c_address, wire);

  if (!i2c_dev->begin()) {
   Serial.println("I2C dev begin failed");
   return false;
  }
...
bool Adafruit_LSM6DS::begin_SPI(uint8_t cs_pin, SPIClass *theSPI,
  ...
  Serial.println("Adafruit_LSM6DS::begin_SPI");
  ...
  spi_dev = new Adafruit_SPIDevice(cs_pin,
                                   ...
                                   theSPI);
  if (!spi_dev->begin()) {
    Serial.println("SPI device init failed");
    return false;
  }
